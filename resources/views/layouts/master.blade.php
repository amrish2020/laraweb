  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        ...
        <div class="info">
          <a href="#" class="d-block">{{ ucfirst(Auth::user()->name) }}<br/>{{ Auth::user()->type }}</a>
        </div>
      </div>
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <router-link to="/hotelpackages" class="nav-link" active-class="active">
                    <i class="fas fa-space-shuttle nav-icon text-teal"></i>
                    <p>Hotel Packages</p>
                </router-link>
              </li>
              @endcan
